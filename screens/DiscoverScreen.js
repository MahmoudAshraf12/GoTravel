...
const DiscoverScreen = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white relative">
            ...
            <View className="flex-row items-center bg-slate-300 mx-4 rounded-xl p-1 shadow-lg mt-4">
        ...
        >
            ...
            <View>
                ...
                <View className= 'items-center flex-row justify-evenly mt-8 flex-wrap'>
                    {mainData?.length > 0 ?(
                    <>
                    {mainData?.map((data, i) => (
                        <ItemCardContainer 
                    ...
                    <>
                        <View className= 'w-full h-[600px] items-center mt-20 '>
                            <Image 
                                source={NotFound}
                                className= ' w-40 h-40 object-cover'
                            />
                            <Text className="text-2xl text-[#428288] font-semibold mt-4">
                                Opps...No Data Found
                            </Text>
                        </View>
                    </>
